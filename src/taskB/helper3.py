...
# ====================================================================
def find_line(v, desired_col, midpoint, direction): # desired_col should be black!
    ...
    while True:
        ...
        if col.value() == desired_col:
            ...
            # fix position
            motor_col_control = Controller(.0001, 0, 0, midpoint)
            ...
            while True:
                ...
                if abs(err) == 0:
                    ...
                    if direction == 1:
                        ...
                        if err > 0:
                            L.run_timed(time_sp=50, duty_cycle_sp = v+signal)
                        elif err < 0:
                            L.run_timed(time_sp=50, duty_cycle_sp = -v-signal)
                    elif direction == -1:
                        if err > 0:
